(function (lwc) {
    ...
    function tmpl($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("p", {
        key: 2
      }, [api_text("Hello Web Component from LWC!!")])];
    }
    ...
    // for web components support
   /*
    import { LightningElement, buildCustomElementConstructor } from 'lwc';
    export default class App extends LightningElement {
    }
    buildCustomElementConstructor(app);
   */
  
   var cel = lwc.buildCustomElementConstructor(main);
   window.customElements.define('m-hw', cel);

   registerWireService(lwc.register);

   // comment next 2 lines for web components support
