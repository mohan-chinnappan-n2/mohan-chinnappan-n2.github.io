(function (lwc) {
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".list-first" + shadowSelector + " {border-bottom: 1px solid red;padding-top: 5px;}\n.list-last" + shadowSelector + " {border-bottom: 1px solid steelblue;padding-bottom: 5px;}\n";
    }
    ...
    * */
    ...
    function tmpl$l($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("h3", {
        key: 0
      }, [api_text("API Version "), api_dynamic($cmp.version)]), api_custom_element("lightning-card", _lightningCard, {
        props: {
          "title": "Documents Needed",
          "iconName": "custom:custom14"
        },
        key: 8
      }, api_flatten([api_element("ul", {
        classMap: {
          "slds-m-around_medium": true
        },
        key: 4
      }, api_iterator($cmp.docsReqd, function (itValue, itIndex, itFirst, itLast) {
        return api_element("li", {
          key: api_key(3, itValue.id)
        }, [itFirst ? api_element("div", {
          classMap: {
            "list-first": true
          },
          key: 1
        }, []) : null, itLast ? api_element("div", {
          classMap: {
            "list-last": true
          },
          key: 2
        }, []) : null, api_dynamic(itValue.name)]);
      })), api_iterator($cmp.fieldsNeeded, function (itValue, itIndex, itFirst, itLast) {
        return api_custom_element("lightning-input", _lightningInput, {
          attrs: {
            "data-id": itValue.id
          },
          props: {
            "id": api_scoped_id(itValue.id),
            "label": itValue.name,
            "placeholder": itValue.placeholder,
            "type": itValue.type
          },
          key: api_key(5, itValue.id),
          on: {
            "change": _m0 || ($ctx._m0 = api_bind($cmp.handleChange))
          }
        }, [api_text(">")]);
      }), $cmp.companyName ? api_element("p", {
        key: 6
      }, [api_text("Company Name: "), api_dynamic($cmp.companyName), api_text(" with employees:      "), api_dynamic($cmp.numEmp), api_text(" Load amount: "), api_dynamic($cmp.loanAmount)]) : null, api_element("footer", {
        key: 7
      }, [api_text(" SBA Loan Application Documents")])])), api_element("div", {
        classMap: {
          "chart": true,
          "slds-m-around_medium": true
        },
    ...
    if (_implicitStylesheets) {
      tmpl$l.stylesheets.push.apply(tmpl$l.stylesheets, _implicitStylesheets);
    }
    ...
    class SBAForm extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.version = '0.0.1';
        ...
        this.docsReqd = [{
          ...
          id: 'SBA Form 912',
          name: 'STATEMENT OF PERSONAL HISTORY'
        }, {
          id: 'SBA Form 413',
          name: 'PERSONAL FINANCIAL STATEMENT'
        }, {
          id: 'P&L',
          name: 'Profit and Loss (P&L) Statement '
        }];
        this.fieldsNeeded = [{
          id: "companyName",
          name: "Company Name",
          ...
          name: "Loan Amount",
          type: "number",
          placeholder: 'Load Amount your are requesting'
        }];
    ...
    lwc.registerDecorators(SBAForm, {
      publicProps: {
        version: {
          config: 0
        }
      },
      fields: ["graphRendered", "docsReqd", "fieldsNeeded", "companyName", "numEmp", "loanAmount"]
    });

    var main = lwc.registerComponent(SBAForm, {
      tmpl: _tmpl$k
    });
