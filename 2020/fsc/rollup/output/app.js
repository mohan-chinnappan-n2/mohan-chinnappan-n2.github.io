(function (lwc) {
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return "h2" + shadowSelector + " {font-size:30px;color:steelblue;font-weight: bold;}\nh3" + shadowSelector + " {font-size: 20px;}\n";
    }
    ...
    * */
    ...
    function tmpl$k($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("h2", {
        key: 2
      }, [api_dynamic($cmp.appName)]), api_custom_element("lightning-input", _lightningInput, {
        props: {
          "type": "text",
          "name": "input1",
          "value": $cmp.appName,
        ...
        key: 3,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.appNameChange))
        }
      }, []), $cmp.showVersion ? api_element("h3", {
        key: 5
      }, [api_dynamic($cmp.appNameVersioned)]) : null, api_element("h3", {
        key: 6
      }, [api_text("Financical Accounts ")]), api_element("ul", {
        key: 7
      }, api_iterator($cmp.contacts, function (contact) {
        return api_element("li", {
          key: api_key(9, contact.Id)
        }, [api_dynamic(contact.Name), api_text(" | "), api_dynamic(contact.Title), api_text(" | "), api_dynamic(contact.Id)]);
      }))];
    }
    ...
    class App extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.appName = "FSC-FA-Rollup";
        this.version = '0.0.1';
        this.appNameVersioned = `${this.appName} - ${this.version}`;
