...
const greetingMessages = {
  bd: {
    msg: "Happy Birthday",
    audio:
      "https://raw.githubusercontent.com/mohan-chinnappan-n/thirukkural-songs/master/greetings/Happy_Birthday_To_You_C_Major.mp3",
  },
  gm: {
    msg: "Greetings",
    audio:
      "https://raw.githubusercontent.com/mohan-chinnappan-n/thirukkural-songs/master/greetings/greet-1.mp3",
  },
};
...
document.addEventListener("DOMContentLoaded", (event) => {
  ...
  if (greet) {
    ...
    const msg = `${greetingMessages.gm.msg}${
      getName() ? ", " + getName() : ""
    }`;
    document.getElementById("greetings").innerHTML = msg;
    document.getElementById("msgInput").value = msg;
