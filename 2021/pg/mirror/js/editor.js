...
const title = 'Kaṇṇāṭi (கண்ணாடி) Playground';
...
<body class='container'>
    ...
    <hr/>
    <span class="slds-badge slds-theme_success">Srinivasa Ramanujan</span>
    <span class="slds-badge slds-theme_warning">Nikola Tesla</span>
    <span class="slds-badge slds-theme_error">Albert Einstein</span>
    <hr/>
        ...
        <div class="slds-card__header slds-grid">
          <header class="slds-media slds-media_center slds-has-flexi-truncate">
            ...
            <div class="slds-no-flex">
              <button onclick="alert('New')" class="slds-button slds-button_neutral">New</button>
            </div>
          </header>
        </div>
