        ...
        return new Promise((resolve, reject) => {
            const query = this.query(soql, _options)
                ...
                if (totalSize > records.length) {
                    process.emitWarning(`The query result is missing ${totalSize -
                    ...
                    this._logger.warn(`The query: ${soql} result is missing ${totalSize - records.length} records due to an API limit.`);
                }
                resolve({
                    done: true,
                    totalSize,
